...
ru:{
  ...
  lbl_cs:"Оценка сообщества",lbl_time:"Время",lbl_note:"Заметка",
  tab_all_aria:"Все игры — домашний экран",tab_catalog:"Библиотека",tab_fav:"Избранное",fav_on:"В избранное",fav_off:"Убрать из избранного",search_ph:"Поиск",add_btn:"Добавить",prompt_name:"Название игры:",sort_aria:"Сортировка",
  ...
  empty:"Пока пусто.",empty_search:"Ничего не найдено. Нажми «+», чтобы внести эту игру.",
  ...
  ref_new_series:"Создать новую серию «{v}»?",
  ref_new_genre:"Создать новый жанр «{v}»?",
...
en:{
  ...
  lbl_cs:"Community score",lbl_time:"Time",lbl_note:"Note",
  tab_all_aria:"All games — home screen",tab_catalog:"Library",tab_fav:"Favorites",fav_on:"Add to favorites",fav_off:"Remove from favorites",search_ph:"Search",add_btn:"Add",prompt_name:"Game title:",sort_aria:"Sort",
  ...
  empty:"Nothing here yet.",empty_search:"Nothing found. Tap “+” to add this game.",
  ...
  ref_new_series:"Create new series “{v}”?",
  ref_new_genre:"Create new genre “{v}”?",
